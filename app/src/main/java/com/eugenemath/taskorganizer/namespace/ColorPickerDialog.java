...
public class ColorPickerDialog extends Dialog {
	...
	private static class ColorPickerView extends View {
		...
		protected void onDraw(Canvas canvas) {
			...
			if (Color.red(mCurrentColor)+Color.green(mCurrentColor)+Color.blue(mCurrentColor) < 384)
				...
				mPaint.setColor(Color.BLACK);
			canvas.drawText(getContext().getString(R.string.from_code19), 74, 340, mPaint);
			...
			if (Color.red(mDefaultColor)+Color.green(mDefaultColor)+Color.blue(mDefaultColor) < 384)
				...
				mPaint.setColor(Color.BLACK);
			canvas.drawText(getContext().getString(R.string.from_code18), 202, 340, mPaint);
		}

		@Override
		protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
			setMeasuredDimension(276, 366);
			//setMeasuredDimension(452, 732);
		}
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle(getContext().getString(R.string.from_code20));
    }
}
